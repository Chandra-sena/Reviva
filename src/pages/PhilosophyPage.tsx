...
export const PhilosophyPage: React.FC<PhilosophyPageProps> = ({ onOpenEnquiry }) => {
  return (
    <div style={{ background: '#ffffff', color: '#111827' }}>
      ...
      <section 
        style={{
          background: 'linear-gradient(180deg, rgba(13, 22, 22, 0.9) 0%, rgba(13, 22, 22, 0.7) 100%), url("https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1920&q=80") center/cover no-repeat',
      ...
      >
        <div className="container">
          ...
          <p className="font-script" style={{ maxWidth: '700px', margin: '0 auto', fontSize: '2rem', color: '#ffffff', lineHeight: 1.4 }}>
            Life is Beautiful
          </p>
        </div>
      </section>
      ...
      <section id="passions" style={{ padding: '5rem 0', borderBottom: '1px solid #e5e7eb' }}>
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '3.5rem', alignItems: 'center' }}>
            <div style={{ background: 'linear-gradient(135deg, #9E783C 0%, #4A381C 100%)', borderRadius: '8px', boxShadow: '0 20px 40px rgba(0,0,0,0.1)', minHeight: '360px', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
              <p className="font-script" style={{ fontSize: '3rem', color: '#ffffff', textAlign: 'center', margin: 0 }}>
                Life is Beautiful
              </p>
            </div>
      ...
      <section id="way" style={{ padding: '5rem 0', background: '#f8fafc', borderBottom: '1px solid #e5e7eb' }}>
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '2rem' }}>
            <div style={{ background: '#fff', padding: '2rem', borderRadius: '8px', border: '1px solid #e2e8f0', boxShadow: '0 4px 12px rgba(0,0,0,0.04)' }}>
      ...
      <section id="vision" style={{ padding: '5rem 0' }}>
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '3rem' }}>
            <div style={{ background: '#0d1616', color: '#fff', padding: '3rem 2.5rem', borderRadius: '12px' }}>
