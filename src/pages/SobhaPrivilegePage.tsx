...
interface SobhaPrivilegePageProps {
  cityInfo: CityInfo;
  onNavigate: (path: string) => void;
  onOpenEnquiry: () => void;
}

export const SobhaPrivilegePage: React.FC<SobhaPrivilegePageProps> = ({ cityInfo, onOpenEnquiry }) => {
    ...
    <div style={{ background: '#ffffff', color: '#111827', minHeight: '100vh', paddingBottom: '5rem' }}>
      ...
      <section 
        style={{
          ...
          width: '100%',
          height: '380px',
          background: `linear-gradient(180deg, rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.7) 100%), url('https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1600&q=80') center/cover no-repeat`,
          display: 'flex',
      ...
      <div className="container" style={{ paddingTop: '3.5rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem', marginBottom: '4rem' }}>
          {[
            ...
            return (
              <div key={idx} style={{ background: '#f8fafc', padding: '2rem', borderRadius: '10px', border: '1px solid #e2e8f0', textAlign: 'center', boxShadow: '0 4px 12px rgba(0,0,0,0.03)' }}>
        ...
        <div style={{ background: '#0f172a', color: '#ffffff', padding: '3.5rem 2rem', borderRadius: '12px', textAlign: 'center' }}>
