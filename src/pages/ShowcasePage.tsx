        ...
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '2rem' }}>
            {[
              ...
              <div key={idx} style={{ background: '#f8fafc', border: '1px solid #e2e8f0', padding: '2rem', borderRadius: '8px' }}>
      ...
      <section id="awards" style={{ padding: '5rem 0', background: '#f8fafc' }}>
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
            <div style={{ background: '#fff', border: '1px solid #e2e8f0', padding: '2rem', borderRadius: '8px', textAlign: 'center' }}>
