    ...
    <footer style={{ background: '#003831', color: '#ffffff', borderTop: '1px solid rgba(255,255,255,0.1)', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1, padding: '3.5rem 0 2.5rem 0' }}>
        <div className="container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1.5rem' }}>
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', width: '153px' }}>
                ...
                <div style={{ width: '115.5%', alignSelf: 'flex-end', marginTop: '3px' }}>
                  <span style={{ fontSize: '0.59rem', fontWeight: 300, letterSpacing: '0.329em', color: '#e5b869', textTransform: 'uppercase', display: 'block', textAlign: 'center' }}>
                    PROJECTS
                  </span>
                </div>
              </div>
          ...
          >
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.6rem', marginBottom: '1.5rem', padding: '0.85rem 1rem', background: 'rgba(255,255,255,0.03)', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.06)' }}>
                ...
                <a
                  ...
                  style={{ fontSize: '0.78rem', color: '#94a3b8', lineHeight: 1.6, textDecoration: 'none', fontWeight: 300 }}
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginBottom: '1.5rem', padding: '0.85rem 1rem', background: 'rgba(255,255,255,0.03)', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.06)' }}>
                ...
                <a href="mailto:info@revivaprojects.com" style={{ fontSize: '0.78rem', color: '#94a3b8', textDecoration: 'none', fontWeight: 300 }}>
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginBottom: '1.5rem', padding: '0.85rem 1rem', background: 'rgba(255,255,255,0.03)', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.06)' }}>
                ...
                <a href="tel:+919148536320" style={{ fontSize: '0.78rem', color: '#94a3b8', textDecoration: 'none', fontWeight: 300 }}>
                  +91 91485 36320
                </a>
              </div>
              <h4 style={{ fontSize: '0.72rem', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '3px', color: '#9E783C', marginBottom: '1.25rem' }}>
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginBottom: '1.5rem', padding: '0.85rem 1rem', background: 'rgba(255,255,255,0.03)', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.06)' }}>
                ...
                <a href="https://www.revivaprojects.com" target="_blank" rel="noopener noreferrer" style={{ fontSize: '0.78rem', color: '#94a3b8', textDecoration: 'none', fontWeight: 300 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.65rem', fontSize: '0.82rem' }}>
                ...
                <span style={{ color: '#64748b', fontSize: '0.78rem', lineHeight: 1.5, fontWeight: 300 }}>
          ...
          <div style={{ borderTop: '1px solid rgba(255,255,255,0.12)', paddingTop: '1.5rem', paddingBottom: '1rem' }}>
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
              <div style={{ display: 'flex', gap: '1.25rem' }}>
                <button onClick={() => onNavigate('/privacy-policy')} style={{ background: 'none', border: 'none', color: '#94a3b8', cursor: 'pointer', fontSize: '0.78rem' }}>Privacy Policy</button>
                <button onClick={() => onNavigate('/terms-and-conditions')} style={{ background: 'none', border: 'none', color: '#94a3b8', cursor: 'pointer', fontSize: '0.78rem' }}>Terms & Conditions</button>
                <button onClick={() => onNavigate('/disclaimer')} style={{ background: 'none', border: 'none', color: '#94a3b8', cursor: 'pointer', fontSize: '0.78rem' }}>RERA Disclaimer</button>
              </div>
