          ...
          >
            <div>
              ...
              <div style={{ fontSize: '2.5rem', fontWeight: 800, margin: '0.5rem 0 1.5rem 0' }}>
                ...
                <span style={{ fontSize: '1rem', color: 'var(--text-secondary)', fontWeight: 400 }}> / month</span>
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.9rem' }}>
                  ...
                  <strong style={{ color: 'var(--text-primary)' }}>{formatCurrency(loanAmount)}</strong>
                </div>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.9rem' }}>
                  ...
                  <strong style={{ color: 'var(--text-primary)' }}>{formatCurrency(totalInterest)}</strong>
                </div>

                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.9rem', paddingTop: '0.75rem', borderTop: '1px solid rgba(255,255,255,0.1)' }}>
                  <span style={{ color: 'var(--text-secondary)' }}>Total Amount Payable:</span>
                  <strong style={{ color: 'var(--primary-accent)', fontSize: '1.05rem' }}>{formatCurrency(totalPayment)}</strong>
                </div>
              </div>
            </div>
