...
export const CompletedProjects: React.FC<CompletedProjectsProps> = ({ projects }) => {
  ...
  return (
    <section id="delivered" style={{ padding: '4rem 0', borderTop: '1px solid var(--border-subtle)' }}>
      <div className="container">
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '1rem', marginBottom: '3rem' }}>
          <button
            ...
            className={activeTab === 'Residential' ? 'btn-primary' : 'btn-outline'}
          ...
          <button
            ...
            className={activeTab === 'Commercial' ? 'btn-primary' : 'btn-outline'}
            style={{ padding: '0.75rem 2rem' }}
          >
            <Building size={16} />
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(320px, 1fr))', gap: '2rem' }}>
          {filtered.map((item) => (
            <div key={item.id} className="glass-panel" style={{ overflow: 'hidden', borderRadius: '12px' }}>
