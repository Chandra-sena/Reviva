    ...
    <div className="page-enter" style={{ paddingBottom: '4rem' }}>
      <div style={{ background: 'linear-gradient(180deg, rgba(18, 24, 38, 0.95) 0%, rgba(10, 14, 23, 1) 100%)', borderBottom: '1px solid var(--border-subtle)', padding: '3rem 0', position: 'relative', overflow: 'hidden' }}>
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <h1 className="reveal gold-shimmer-text" style={{ fontFamily: 'var(--font-heading)', fontSize: '2.75rem' }}>
            {title}
          </h1>
          <p className="reveal" style={{ color: 'var(--text-secondary)', marginTop: '0.75rem', maxWidth: '700px', fontSize: '1.1rem' }}>
      ...
      <div className="container" style={{ marginTop: '3rem', maxWidth: '850px' }}>
        <div className="glass-panel reveal" style={{ padding: '2.5rem', borderRadius: '16px', lineHeight: 1.8, color: 'var(--text-secondary)' }}>
