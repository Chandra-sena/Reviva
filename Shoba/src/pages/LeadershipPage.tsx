...
export const LeadershipPage: React.FC<LeadershipPageProps> = () => {
  return (
    <div className="page-enter" style={{ background: '#ffffff', color: '#111827' }}>
      ...
      <section
        style={{
          background: 'linear-gradient(180deg, rgba(13, 22, 22, 0.9) 0%, rgba(13, 22, 22, 0.75) 100%), url("/media/images/office-lounge-plants.jpg") center/cover no-repeat',
      ...
      >
        <BirdsAccent corner="top-left" size="13%" opacity={0.13} color="#3a7d6f" />
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '3.5rem', alignItems: 'center' }}>
            <div className="reveal-left">
              <div className="reviva-card-hover" style={{ borderRadius: '12px', overflow: 'hidden', boxShadow: '0 20px 40px rgba(0,0,0,0.15)', background: 'linear-gradient(135deg, #9E783C 0%, #4A381C 100%)', minHeight: '360px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      {/* Chairman's Message */}
      <section id="message" className="reveal" style={{ padding: '5rem 0', background: '#f8fafc', borderBottom: '1px solid #e5e7eb' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          <div className="reviva-card-hover" style={{ background: '#ffffff', border: '1px solid #e2e8f0', padding: '3.5rem', borderRadius: '12px', boxShadow: '0 10px 30px rgba(0,0,0,0.04)' }}>
      ...
      <section id="leader" style={{ padding: '5rem 0' }}>
        <div className="container">
          ...
          <div className="stagger-children" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: '2rem' }}>
            {[
              ...
              <div key={idx} className="reviva-card-hover" style={{ background: '#f8fafc', border: '1px solid #e2e8f0', padding: '2rem', borderRadius: '8px', textAlign: 'center' }}>
