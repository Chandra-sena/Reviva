...
export const THEME_PRESETS: ThemeConfig[] = [
  {
    id: 'reviva-primary',
    name: 'Reviva Gold & Dark Onyx (Signature)',
...
export const INITIAL_CITY_INFO: CityInfo = {
  ...
  heroTitle: 'Flats & Eco-Conscious Residences for Sale in Bengaluru',
  heroSubtitle: 'Our Nature is truly down to earth — experience thoughtfully curated, eco-conscious spaces crafted by Reviva Projects.',
  developerName: 'Reviva Projects',
  developerLogoText: 'REVIVA',
  stats: {
    legacyYears: 5,
    deliveredSqFt: '1+ Million',
    projectsDelivered: 2,
    happyFamilies: '500+',
  }
};
...
export const INITIAL_PROPERTIES: Property[] = [
  // --- FLAGSHIP BENGALURU PROJECTS ---
  {
    ...
    image: '/media/images/reviva-trinity-lifescape-3.jpg',
    gallery: [
      '/media/images/reviva-trinity-lifescape-3.jpg',
      '/media/images/reviva-trinity-lifescape-2.jpg',
  ...
  },
  {
    ...
    amenities: [
      ...
      'Gymnasium',
      'Landscaped Patios',
      'Outdoor Cafés & Gazebos',
      'Party Hall',
      '24/7 Security'
    ],
    reraNumber: 'PRM/KA/RERA/1251/446/PR/140525/007741',
  ...
  },
  {
    ...
    image: '/media/images/legacy-heritage-hero.jpg',
    gallery: ['/media/images/legacy-heritage-hero.jpg'],
  ...
  },
  {
    ...
    image: '/media/images/eco-house-hero.jpg',
    gallery: ['/media/images/eco-house-hero.jpg'],
  ...
  },
  {
    ...
    image: '/media/images/modern-architecture-facade.jpg',
    gallery: ['/media/images/modern-architecture-facade.jpg'],
  ...
  },
  {
    ...
    image: '/media/images/modern-interior-design.jpg',
    gallery: ['/media/images/modern-interior-design.jpg'],
  ...
  },
  {
    ...
    gallery: ['/media/images/green-building-exterior.jpg'],
...
export const INITIAL_DELIVERED_PROJECTS: DeliveredProject[] = [
  {
    id: 'del-1',
    name: 'Reviva Vintage Valley (Phase 1)',
    location: 'Channasandra, Whitefield, Bengaluru',
    yearDelivered: '2025',
    totalUnits: 'Maiden Residential Development',
    type: 'Residential',
    image: '/media/images/reviva-vintage-valley.jpg',
    tagline: 'Eco-Living Landmark'
  }
];

export const INITIAL_BLOGS: BlogPost[] = [
  {
    id: 'luxury-sustainable-homes-india',
    title: 'The Rise of Luxury Sustainable Homes in India: A Path to Green Living',
    category: 'Sustainability',
    date: 'Aug 25, 2026',
    readTime: '7 min read',
    image: '/media/images/luxury-villa-pool.jpg',
    snippet: 'India’s affluent homeowners are embracing eco-conscious design without compromising comfort — discover what defines luxury sustainable homes and where India’s green living movement is headed next.',
    content: `In recent years, India has witnessed a growing demand for eco-friendly living solutions, with a particular emphasis on luxury sustainable homes in India. This trend highlights a significant shift towards environmentally responsible living without compromising comfort or style. As climate consciousness rises, affluent homeowners are looking for ways to integrate sustainable practices into their lifestyles while maintaining the opulence they cherish.

### What Defines Luxury Sustainable Homes?
Luxury sustainable homes seamlessly combine eco-conscious design with state-of-the-art amenities. These homes:
• Utilize sustainable materials like bamboo, recycled wood, and eco-friendly concrete.
• Incorporate renewable energy solutions such as solar panels and wind turbines.
• Feature efficient water management systems, including rainwater harvesting and greywater recycling.
• Emphasize energy efficiency with LED lighting, advanced insulation, and smart home technologies.

The essence of these homes lies in their ability to provide a luxurious experience while minimizing the environmental footprint.

### Why Choose Luxury Sustainable Homes in India?
• Environmental Benefits: Sustainable homes significantly reduce carbon emissions. These homes ensure a greener lifestyle by integrating renewable energy sources and energy-efficient appliances.
• Economic Advantages: Although the upfront investment may be higher, luxury sustainable homes offer long-term savings through reduced utility bills and minimal maintenance costs.
• Healthier Living: Homes built with eco-friendly materials reduce exposure to toxins, ensuring better indoor air quality. Additionally, natural ventilation and green spaces contribute to a healthier living environment.
• Architectural Brilliance: Luxury sustainable homes in India are often masterpieces of architecture, blending traditional Indian elements with contemporary designs to create functional and aesthetically pleasing spaces.

### Key Features of Luxury Sustainable Homes in India
• Green Building Materials: Sustainable homes prioritize materials that are renewable, durable, and locally sourced. Materials like fly ash bricks, reclaimed wood, and low-VOC (volatile organic compound) paints are commonly used.
• Renewable Energy Integration: Solar panels, wind turbines, and geothermal heating systems are standard features in these homes. They provide clean energy solutions that cater to the energy-intensive needs of luxury living.
• Water Management Systems: Water scarcity is a pressing concern in India. Luxury sustainable homes include advanced water-saving technologies like dual plumbing systems, rainwater harvesting setups, and wastewater treatment plants.
• Smart Technologies: Smart home systems control lighting, heating, and cooling to optimize energy use. These technologies enhance convenience and contribute to sustainability by reducing unnecessary energy consumption.
• Natural Landscaping: Landscaped gardens, rooftop green spaces, and vertical gardens are essential components. These features improve air quality, enhance aesthetics, and support biodiversity.

### Prominent Locations for Luxury Sustainable Homes in India
• Bangalore: Known as the Silicon Valley of India, Bangalore has seen a surge in eco-friendly residential projects due to its tech-savvy population and awareness of sustainability.
• Mumbai: Space constraints haven’t stopped Mumbai developers from incorporating green technologies into high-end apartments and luxury homes.
• Delhi-NCR: The capital region boasts several green-certified residential projects aimed at creating sustainable urban living spaces.
• Kerala: Known for its connection with nature, Kerala is home to many luxury villas designed with sustainable practices in mind.
• Goa: Goa’s luxury homes often embrace sustainable materials and designs to blend seamlessly with the region’s natural beauty.

### The Role of Builders and Developers
Pioneering developers in India are embracing the concept of luxury sustainable homes in India. They are:
• Implementing IGBC Standards: The Indian Green Building Council (IGBC) sets benchmarks for green building practices. Developers adhere to these standards to gain certification for their projects.
• Creating Awareness: A priority is to educate buyers about sustainable homes’ environmental and economic benefits.
• Investing in Research: Developers are continuously innovating to find cost-effective, sustainable building solutions.

### Challenges in Building Luxury Sustainable Homes
Despite the advantages, there are challenges:
• High Initial Costs: Incorporating advanced green technologies can significantly increase the construction cost.
• Limited Awareness: Not all buyers are aware of the long-term benefits of sustainable living.
• Skill Gap: Building sustainable homes requires specialized knowledge, which is still developing in India.

However, as awareness grows, these challenges are gradually being addressed, paving the way for a greener future.

### Future Trends in Sustainable Luxury Living
• Carbon-Neutral Homes: Developers are exploring ways to create entirely carbon-neutral homes, from construction to daily operations.
• Circular Economy in Construction: Recycling and reusing materials will become a significant aspect of luxury home construction.
• Increased Green Certifications: More homes will adhere to global green standards, enhancing their appeal to environmentally conscious buyers.

Hence the concept of luxury sustainable homes in India is more than just a trend—it’s necessary for the future. As environmental concerns continue to grow, the demand for homes that combine luxury with sustainability is expected to soar. These homes not only reflect the sophistication and values of their owners but also contribute significantly to a greener planet. By choosing a luxury sustainable home, you’re not just making a statement of style and elegance but also championing the cause of environmental stewardship.`
  },
  {
    ...
    date: 'Aug 24, 2026',
    readTime: '6 min read',
    image: '/media/images/modern-home-designs.png',
...
export const INITIAL_FAQS: FaqItem[] = [
  {
    ...
    question: 'Is Reviva Vintage Valley RERA registered?',
    answer: 'Yes, Reviva Vintage Valley is registered under Karnataka RERA with number PRM/KA/RERA/1251/446/PR/140525/007741.'
  },
  {
    id: 'faq-2',
    category: 'Location',
    question: 'Where is Reviva Vintage Valley located?',
    answer: 'Reviva Vintage Valley is situated at Sy No 13, Indian Gas Godown Road, Channasandra, Kadugodi, Bengaluru, Karnataka – 560067.'
  }
];

export const SEO_FOOTER_LINKS = [
  'Reviva Vintage Valley Whitefield',
  '2.5 & 3 BHK Apartments in Channasandra Kadugodi',
  'Reviva Farms Eco Plots & Farm Houses Bengaluru',
  'Reviva Trinity Lifescape Bengaluru',
  'Reviva Projects Head Office Channasandra'
];
