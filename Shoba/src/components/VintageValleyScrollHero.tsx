...
interface VintageValleyScrollHeroProps {
  property: Property;
...
const getFramePath = (index: number): string => {
  ...
  return `/frames-VV/ezgif-frame-${frameNum}.jpg`;
};

export const VintageValleyScrollHero: React.FC<VintageValleyScrollHeroProps> = ({
  property,
  onNavigate,
  onEnquireClick,
}) => {
  ...
  // Robust Concurrent Preloader for all 300 frames
  useEffect(() => {
    ...
    loadImage(0).then(() => {
      ...
      // 2. Load all 300 frames with concurrent queue
  ...
  return (
    <div
      ref={containerRef}
      className="vintage-scroll-container"
      style={{
        position: 'relative',
        width: '100%',
        height: '380vh',
    ...
    >
      ...
      <div
        className="vintage-sticky-viewport"
        style={{
          position: 'sticky',
          top: 0,
          left: 0,
      ...
      >
        ...
        >
          {/* Phase 1: Opening Title (Progress 0.0 - 0.23) */}
          <div
            style={{
              textAlign: 'center',
              maxWidth: '960px',
              transition: 'opacity 0.5s cubic-bezier(0.16, 1, 0.3, 1), transform 0.5s cubic-bezier(0.16, 1, 0.3, 1)',
              opacity: scrollProgress <= 0.23 ? Math.max(0, 1 - (scrollProgress / 0.23) * 1.5) : 0,
              transform: scrollProgress <= 0.23 ? `translateY(${-scrollProgress * 40}px)` : 'translateY(-30px)',
          ...
          >
            ...
            >
              <Sparkles size={12} />
              <span>CLASSICAL ARCHITECTURAL PRELUDE</span>
            </div>
            ...
            >
              The Grace of Classic Living • Channasandra, Whitefield
            </p>
          </div>

          {/* Phase 2: Classical Architectural Elevation (Progress 0.25 - 0.51) */}
          <div
            style={{
              position: 'absolute',
              ...
              transform:
                scrollProgress > 0.24 && scrollProgress < 0.52
                  ? `translateY(${((scrollProgress - 0.38) * 40)}px)`
                  : 'translateY(20px)',
              pointerEvents: scrollProgress > 0.25 && scrollProgress < 0.51 ? 'auto' : 'none',
            }}
          >
            <div
              style={{
            ...
            >
              Timeless Façade & Refined Modern Living
            </h2>
            <p
              style={{
            ...
            >
              Vintage Valley seamlessly merges classical charm with contemporary design, inspired by the rich architectural legacy of classical forms in Whitefield.
            </p>
          ...
          {/* Phase 3: Rooftop Retreat & Leisure (Progress 0.53 - 0.78) */}
          <div
            style={{
              position: 'absolute',
              ...
              transition: 'opacity 0.45s ease, transform 0.45s ease',
              opacity:
                scrollProgress > 0.52 && scrollProgress < 0.79
                  ? Math.sin(((scrollProgress - 0.52) / 0.27) * Math.PI)
                  : 0,
              transform:
                scrollProgress > 0.52 && scrollProgress < 0.79
                  ? `translateY(${((scrollProgress - 0.65) * 40)}px)`
                  : 'translateY(20px)',
              pointerEvents: scrollProgress > 0.53 && scrollProgress < 0.78 ? 'auto' : 'none',
            }}
          >
            <div
              style={{
            ...
            >
              Rooftop Swimming Pool, Patios & Lounges
            </h2>
            <p
              style={{
                color: 'rgba(255,255,255,0.85)',
            ...
            >
              A spacious rooftop oasis complete with swimming pool, outdoor café, gazebos, and cozy seating nooks — crafted for relaxation and connection.
            </p>
