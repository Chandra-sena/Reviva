...
const LOCATIONS_DATA: LocationCard[] = [
  {
    id: 'channasandra-kadugodi',
    name: 'Channasandra, Kadugodi',
  ...
  {
    id: 'eco-farms-bengaluru',
    name: 'Bengaluru Suburbs (Reviva Farms)',
        ...
        >
          ...
          <form onSubmit={handleSearchSubmit} style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', justifyContent: 'center' }}>
            ...
            >
              ...
              <option value="reviva-oneworld">Reviva OneWorld</option>
              <option value="reviva-altair">Reviva Altair</option>
              <option value="reviva-magnus">Reviva Magnus</option>
              <option value="reviva-townpark">Reviva Townpark</option>
              <option value="reviva-ayana">Reviva Ayana</option>
              <option value="reviva-infinia">Reviva Infinia</option>
              <option value="reviva-neopolis">Reviva Neopolis</option>
              <option value="reviva-arbor">Reviva Arbor</option>
              <option value="reviva-waterfront">Reviva Waterfront</option>
            </select>
        ...
        >
          {LOCATIONS_DATA.map((loc) => (
            <div 
              ...
              className="elevate-hover btn-arrow-hover"
              style={{
                background: '#ffffff',
                borderRadius: '8px',
                overflow: 'hidden',
            ...
            >
              <div className="shimmer-hover img-zoom-hover" style={{ height: '220px', overflow: 'hidden', position: 'relative' }}>
                <img 
                  src={loc.image}
                  alt={loc.name}
                  style={{
