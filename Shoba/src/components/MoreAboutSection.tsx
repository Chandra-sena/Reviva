    ...
    <section style={{ background: '#ffffff', padding: '5rem 0', position: 'relative', overflow: 'hidden' }}>
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div className="reveal-scale" style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'center', marginBottom: '3.5rem' }}>
          <span style={{ fontFamily: 'var(--font-accent)', color: '#9E783C', fontSize: '0.8rem', fontWeight: 600, letterSpacing: '2.5px', textTransform: 'uppercase' }}>
            ABOUT REVIVA PROJECTS
          </span>
          <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: 'clamp(2rem, 4vw, 3rem)', fontWeight: 600, color: '#0f172a', marginTop: '0.5rem' }}>
            MORE ABOUT REVIVA
          </h2>
          <p style={{ fontFamily: 'var(--font-body)', color: '#475569', fontSize: '1.05rem', lineHeight: 1.8, marginTop: '1rem' }}>
        ...
        <div className="stagger-children" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '2rem' }}>
          <div className="reviva-card-hover" style={{ background: '#f8fafc', padding: '2rem', borderRadius: '8px', border: '1px solid #e2e8f0', textAlign: 'center' }}>
            ...
            <h4 style={{ fontFamily: 'var(--font-heading)', fontSize: '1.1rem', fontWeight: 600, color: '#0f172a', marginBottom: '0.5rem' }}>
              Backward Integration
            </h4>
            <p style={{ fontFamily: 'var(--font-body)', color: '#64748b', fontSize: '0.88rem', lineHeight: 1.6 }}>
